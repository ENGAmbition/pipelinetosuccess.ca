...
const TestimonialsSection: FC = (): JSX.Element => {
  return (
    <section className="relative z-0 flex h-fit w-screen flex-col items-center bg-white py-20 text-brand-neutral-600">
      ...
      <div className="mx-32 mt-16 flex w-full flex-col gap-16 px-7">
        <div className="flex w-full gap-4 sm:w-3/5">
          <Image
            src="/images/testimonials/profile-1.jpg"
            alt="Profile of User 1"
            className="h-fit w-36 rounded-full"
            width={100}
            height={100}
          />
        ...
        <div className="ml-auto flex w-full gap-4 px-7 sm:w-3/5">
